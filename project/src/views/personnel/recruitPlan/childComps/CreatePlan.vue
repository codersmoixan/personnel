<template>
  <div class="cover">
    <div class="create-container add-view">
      <div class="create-top content-top">
        <span>添加计划</span>
        <div class="close" @click="createClose">x</div>
      </div>
      <div class="create ov-auto">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      createClose() {
        this.isShow = false
        this.$emit('isShowChange', this.isShow)
      },
      clearData() {
        // 取消清空所以已经填了的数据
